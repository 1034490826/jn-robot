 ...
 */
package com.jn.robot.config.datasource;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "robot.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2, proxyTargetClass = true)
@MapperScan(basePackages = {"com.jn.robot.modular.*.dao", "com.jn.robot.multi.mapper"})
public class MultiDataSourceConfig {
     ...
     */
    @Bean
    @ConfigurationProperties(prefix = "robot.muti-datasource")
